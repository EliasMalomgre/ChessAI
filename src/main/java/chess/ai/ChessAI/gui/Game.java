...
public class Game {
    ...
    */
    public Button constructExportPGN() {
        ...
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/filesymbol.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    */
    public Button constructFlipButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/blueflip.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructResetButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/greenflip.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructNewButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/boardsparkle.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructAppearanceButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/whitepawn.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructLeftButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/leftarrow.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructRightButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/rightarrow.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        image.setFitHeight(35*app.getScale());
    ...
    */
    public Button constructBackButton() {
        ...
        ImageView image = null;
        try {
            image = new ImageView(new Image(Files.newInputStream(Paths.get("src/main/resources/arrowsmall.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
